...
import { deleteManufacturer } from "@/app/actions/finance-manufacturers"
...
export function ManufacturerActions({ manufacturerId, manufacturerName }: ManufacturerActionsProps) {
  ...
  function handleDelete() {
    ...
    startDelete(async () => {
      ...
      router.push("/finance/manufacturing")
      router.refresh()
    })
  }
  ...
  return (
    <div className="flex flex-col items-end gap-1.5">
      ...
      <ManufacturerFormDialog mode="rename" manufacturerId={manufacturerId} initialName={manufacturerName} open={renameOpen} onOpenChange={setRenameOpen} />

      <ConfirmDialog
        open={confirmOpen}
        onOpenChange={setConfirmOpen}
        title="Delete manufacturer"
        description={`Are you sure you want to delete "${manufacturerName}"? All of its invoices will be deleted too. This cannot be undone.`}
        confirmLabel="Delete"
        variant="destructive"
